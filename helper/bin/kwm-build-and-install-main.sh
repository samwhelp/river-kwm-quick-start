...
sys_kwm_config_install () {
	...
	echo
	echo install -Dm644 "${REF_ASSET_TEMPLATE_DIR_PATH}/main/config.zig" "${REF_MASTER_KWM_DIR_PATH}/config.zig"
	echo
	install -Dm644 "${REF_ASSET_TEMPLATE_DIR_PATH}/main/config.zig" "${REF_MASTER_KWM_DIR_PATH}/config.zig"
